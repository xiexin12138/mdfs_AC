		...
		<div style="margin:20px 0;">
			<el-form status-icon label-width="150px" ref="groupmanageform" :model="groupmanageform" :rules="newrule">
				<el-form-item label="用户名" prop="user" >
					<el-input size="small" v-model="groupmanageform.user"></el-input>
				</el-form-item>
				...
				<el-form-item label="操作" prop="operation" >
					<el-input size="small" v-model="groupmanageform.operation"
					placeholder="add/delete"></el-input>
				</el-form-item>	
	...
	data(){
		...
		return {
			...
			newrule:{
				...
				operation:[
					{ required:true, message:'请正确的操作，添加/移除：add/delete', trigger:'blur'}
				],
			...
			this.$refs[formName].validate((valid) => {
				if (valid) {
					...
					let data = {
						...
						operation: this.groupmanageform.operation,
					}
