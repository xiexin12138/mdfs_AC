      ...
      <div style="margin:20px 0;">
        <el-form status-icon label-width="120px" ref="newuserform" :model="newuserform" :rules="newuserrule">
          ...
          <el-form-item label="有效期" prop="expire">
            <el-date-picker style="width:380px;" size="small" v-model="newuserform.expire" type="datetime" placeholder="选择日期" value-format="yyyy-MM-dd HH:mm:ss">
            </el-date-picker>
      ...
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          userTable.AddUser(data).then(() => {
            ...
            this.$router.push({
              path: global_.FS_USER_MANAGE.indexpage
            })
          }).catch((e) => {
